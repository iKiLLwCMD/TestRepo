...
$(document).ready(function(){jQuery('.adminRichText').ckeditor();updatePublishBtn();$('.privateChkBox').change(function(){updatePublishBtn();});$('#fullScreen').click(function(){var editor=CKEDITOR.instances["Post_PostContent"];editor.execCommand('maximize');});$('#contentPreview').click(function(){var editor=CKEDITOR.instances["Post_PostContent"];editor.execCommand('preview');});$('.postUrl,.postUrlPrefix,#btnUpdate,#btnCancel').hide();$('.postTitle').change(function(){var postId=parseInt($('#Post_PostID').val());if(postId==0){var text=$(this).val();if(text.trim()!=''){getVerifiedUrl(text);}else{clearUrlFields();}}});if($('.postUrlValue').val()!=null&&$('.postUrlValue').val()!=''){var prefixText='';if($('#Post_PostID').val()!='0'&&$('#Post_EntryType').val()=='1'){prefixText=getDatePrefix()+'/';}
...
else{clearUrlFields();}});$('#btnCancel').click(function(){$('.postUrl,.postUrlPrefix').hide();$('.postUrlLabel').show();$('#btnUpdate').hide();$('#btnCancel').hide();});});function clearUrlFields(){$('.postUrlLabel').text('---').unbind('click');$('.postUrlPrefix').text('');$('.postUrlValue').val('');$('.postUrl').val('');}
...
$(document).ready(function(){$('#showHelp').click(function(e){e.preventDefault();$("#dialog").dialog({width:600,height:400});});$('.possibilityHeader').click(function(){var content=$(this).next('.possibilityContent');$('.possibilityContent').hide();$(content).slideToggle('slow');});$('.brush-not-selected').hide();$('.possibilityContent').hide();$('#chk-show-all').change(function(){if($(this).is(':checked')){$('.brush-not-selected').show();$('.possibilityContent').hide();$('.selected-brushes-title').html('All brushes:');}
else{$('.brush-not-selected').hide();$('.possibilityContent').hide();$('.selected-brushes-title').html('Selected brushes:');}});});$(document).ready(function(){var li=$('li.current');var submnu;if($(li).parent().attr('class')!='no-display sub-menu'){submnu=$(li).find('ul.sub-menu');$(submnu).removeClass('no-display').addClass('display');}
...
$(document).ready(function(){$('#AkismetEnabled').change(function(){$('.akismetAdvancedOptions').toggle();});if($('#AkismetEnabled').is(':checked')){$('.akismetAdvancedOptions').show();}});$(document).ready(function(){$('#forgottenPswd').click(function(e){e.preventDefault();$('.login-errors').html('');$('.client-login-errors').html('');$('#username').val('username');$('#fake-password').show().val('password');$('#passwd').hide();$('#slick-login').hide();$('#slick-forgotten').show();});$('#loginForm').click(function(e){e.preventDefault();$('#results').html('');$('#emailAddress').val('your email address');$('#slick-login').show();$('#slick-forgotten').hide();});$('#btnLogin').click(function(){if($('#username').val()!='username'&&$('#passwd').val()!='password'){$('.client-login-errors').html('');return true;}
$('.login-errors').html('');$('.client-login-errors').html('Invalid username/password');return false;});$('#btnForgottenPswd').click(function(){if($.trim($('#emailAddress').val())!=''&&$.trim($('#emailAddress').val())!='your email address'){return true;}
$('#emailAddress').val('your email address');return false;});$('#btnClose').click(function(){$('#dialog').dialog('close');});});$(document).ready(function(){$('.col-no-display').each(function(){var index=$(this).index();if(index>0){$('#manage-table tr').each(function(){$(this).find('td:eq('+index+')').hide();});$('#manage-table tfoot tr').find('th:eq('+index+')').hide();$('.col-no-display').hide();}});});$(document).ready(function(){$('#btnCreateCategory').click(function(){var text=$('#txtCat').val().trim();var regex=/\<[\S* ]*\>/;var alphaRegex=/[a-zA-Z]{1,}/;if(text.match(regex)!=null){showMessage('Category name entered is invalid');return;}
if(text.match(alphaRegex)==null){showMessage('Category name entered is invalid, should have at least 1 alphabet');return;}
